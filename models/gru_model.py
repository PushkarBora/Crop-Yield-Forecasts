...
def auto_tune_gru(
    ...
    grid = {
        ...
        "epochs":        irange(params["gru_epochs_min"],
                                params["gru_epochs_max"],
                                params["gru_epochs_step"]),
    }
...
def run_gru(
    ...
    if use_tune:
        ...
        lags_values = list(range(
            params.get("gru_lags_min", 2),
            params.get("gru_lags_max", 5) + 1,
            params.get("gru_lags_step", 1),
        ))
